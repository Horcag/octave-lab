Пожалуйста, вот текст 4-го параграфа "Численные методы решения задачи Коши для обыкновенных дифференциальных уравнений" из предоставленного документа, отформатированный в Markdown:
